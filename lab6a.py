...
class Student:
    ...
    def displayGPA(self):
        # Check if there are courses added, if not, handle ZeroDivisionError by setting GPA to 0.0
        gpa = sum(self.courses.values()) / len(self.courses) if self.courses else 0.0
